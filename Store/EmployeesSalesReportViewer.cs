...
namespace Store
{
    public partial class EmployeesSalesReportViewer : Form
    {
        DateTime date1;
        DateTime date2;

        public EmployeesSalesReportViewer(string date1, string date2)
        {
            InitializeComponent();
        ...
        private void EmployeesSalesReportViewer_Load(object sender, EventArgs e)
        {
            this.MEGABYTDataSet.EnforceConstraints = false;
            MEGABYTDataSetTableAdapters.employees_salesTableAdapter esTA = new MEGABYTDataSetTableAdapters.employees_salesTableAdapter();
            esTA.Fill(this.MEGABYTDataSet.employees_sales, date1, date2);
